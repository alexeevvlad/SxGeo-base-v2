...
$L['cfg_userestapi'] =array('Использовать sypexgeo REST API', 'REST API позволяет с помощью простого запроса по HTTP или HTTPS получить наиболее актуальную и расширенную информацию об IP, используя самую свежую базу данных Sypex Geo');
